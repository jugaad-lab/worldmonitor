/**
 * Analysis Constants - ported from src/utils/analysis-constants.ts
 * Shared thresholds, weights, and utility functions
 */
...
export function generateDedupeKey(type, identifier, value) {
  ...
  return `${type}:${identifier}:${Math.abs(value).toFixed(1)}`;
}
